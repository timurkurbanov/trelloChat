  ...
  return id !== '' ? (
    ...
    <div style={{ textAlign: 'left', margin: '30vh auto', width: '100%' }}>
        <form onSubmit={event => handleSubmit(event)}>
            ...
            <button style={{ marginTop: '1%', fontSize: '16px', color: 'white', backgroundColor: '#007BFF', padding: '9px 20px', textAlign: 'center', textDecoration: 'none' }} type="submit">Start</button>
        </form>
    </div>
  );
};
